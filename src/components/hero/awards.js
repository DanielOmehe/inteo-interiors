...
const awards = [
  {
    src: "/images/german-design-award.png",
    name: "German Design Award",
    year: "2021",
  },
  {
    src: "/images/a-design-award.png",
    name: "Gold A' Design Award",
    year: "2021",
  },
  {
    src: "/images/if-design-award.png",
    name: "IF Design Award",
    year: "2020",
  },
  {
    src: "/images/good-design-award.png",
...
const InteoAwardsLeft = () => {
  return (
    <div className="flex mr-8 items-center sm:gap-0 text-gray-400 sm:w-1/4 sm:mr-6 sm:mt-6 sm:-ml-8">
      <PageHeaderSmall variant={"text-lg sm:text-2xl -rotate-90 text-gray-400"}>
        Awards
      </PageHeaderSmall>
      <Image src={"/images/Line.png"} className="sm:-ml-4" width={100} height={1} alt="line" />
    </div>
  );
};
...
const InteoAwardsContainer = ({ children }) => {
  return (
    <div className="flex gap-8 md:grid md:grid-cols-2 sm:grid-cols-1 sm:grid-rows-4">
      {children}
    </div>
  );
};
...
const InteoAward = ({ path, name, desc }) => {
  return (
    <div className="flex w-1/4 text-left gap-4 items-center w-max">
      ...
      <div className="">
        <InteoParagraphText variant={"text-base text-gray-400"}>
          {name}
        </InteoParagraphText>
        <InteoParagraphText variant={"text-base text-gray-400"}>
          {desc}
